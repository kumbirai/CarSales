...
/**
 * This class contais the group of text fields representing the cars information
 * visually inside a panel. @ * PUBLIC FEATURES: // Constructors public
...
public class CarDetailsComponents extends JPanel implements ComponentListener {
	...
	/**
	 * set up a new CarDetailComponents object and return a reference to the
	 * object which is a kind of panel
	 */
	...
	public void componentResized(ComponentEvent ev) {
		if (ev.getSource() == this) {
			...
			if (width >= 0) {
				...
				infoTextArea.setColumns((width / divFactor) + 3); // this text
																	// box is
																	// larger
			}
		}
	 ...
	 * 
	 * @param c
	 *            the car to display details about
	 */
	public void displayDetails(Car c) {
		manufacturerTextField.setText(c.getManufacturer().getManufacturer());
		yearTextField.setText(Integer.toString(c.getCarYear()));
		modelTextField.setText(c.getModel());
		priceTextField.setText(c.getPrice().toString());
